...
class svm_scale
{
	...
	private void output(int index, double value)
	{
		...
		if(value != 0)
		{
			 ...
			 * You can put the contents of output file into xls directly.
			 * (1)index:vable -- generate file for training in cmd
			 * (2)value -- generate file for .xls file, which can be read in jmain.java.
			 */
